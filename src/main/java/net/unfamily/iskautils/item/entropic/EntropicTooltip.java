...
public final class EntropicTooltip {
    ...
    public static void appendToolLines(List<Component> tooltip, String path) {
        ...
        switch (path) {
            ...
            case "entropic_chestplate" -> ArtifactTooltipUtil.addTechLine(tooltip::add,
            ...
            case "entropic_leggings" -> ArtifactTooltipUtil.addTechLine(tooltip::add,
            ...
            case "entropic_boots" -> ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.boots.fall");
            case "entropic_axe" -> {
            ...
            case "entropic_hoe" -> appendHoeCrop(tooltip);
            default -> {}
        }
    }

    private static void appendHoeCrop(List<Component> tooltip) {
        if (!Config.entropicHoeCropPowerEnabled) {
            return;
        }
        if (Config.entropicHoeRequireMatureCrop) {
            ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.hoe.crop.mature");
        } else {
            ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.hoe.crop.any");
        }
    }
    ...
    private static void appendPaxelLines(List<Component> tooltip) {
        appendUnbreakable(tooltip);
        ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.paxel.combo");
    ...
    private static void appendAxeStrip(List<Component> tooltip) {
        ...
        ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.axe.strip");
    }
    ...
    private static void appendShovelBrush(List<Component> tooltip) {
        ...
        ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.entropic.shovel.brush");
    }
