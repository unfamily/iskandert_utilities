...
public class ExperienceModuleItem extends Item {
    ...
    public void appendHoverText(
        ...
        if (flag.hasShiftDown()) {
            tooltip.accept(Component.translatable("tooltip.iska_utils.mob_reaper_module.max", Config.reaperExperienceUpgradeMax)
                    .withStyle(ChatFormatting.GRAY));
            tooltip.accept(Component.translatable("tooltip.iska_utils.mob_reaper_module.experience_bonus",
