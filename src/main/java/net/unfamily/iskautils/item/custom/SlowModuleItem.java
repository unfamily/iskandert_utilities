...
/**
 * Custom Item for Slow Module with tooltip showing power and max installable count
 */
public class SlowModuleItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            double power = Config.fanAccelerationModulePowers != null && Config.fanAccelerationModulePowers.size() > 0 
                    ? Config.fanAccelerationModulePowers.get(0) : 0.1;
            ...
            tooltip.add(Component.translatable("tooltip.iska_utils.fan_module.max_installable", 
                    Component.translatable("tooltip.iska_utils.fan_module.slow_module"), 
