...
public class RunicDiceItem extends Item {
    ...
    public static double getStoredBonus(ItemStack stack) {
        ...
        return tag.getDouble(NBT_ATTACK_SPEED_BONUS);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        ArtifactTooltipUtil.addLoreLine(tooltip::add, "tooltip.iska_utils.runic_dice.desc0");
        ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.runic_dice.desc1");
        ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.runic_dice.desc2",
        ...
        if (bonus >= 0.0D) {
            ArtifactTooltipUtil.addTechLine(tooltip::add, "tooltip.iska_utils.runic_dice.desc3",
