...
public class NormalDamageModuleItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (ScreenAccess.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.iska_utils.mob_reaper_module.max", Config.reaperNormalUpgradeMax)
                    .withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("tooltip.iska_utils.mob_reaper_module.normal_bonus", Config.reaperNormalBonusPerModule)
                    .withStyle(ChatFormatting.GRAY));
        } else {
