...
public class BeheadingModuleItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(Component.translatable("tooltip.iska_utils.mob_reaper_module.max", Config.reaperBeheadingUpgradeMax)
                    .withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("tooltip.iska_utils.mob_reaper_module.beheading_chance",
