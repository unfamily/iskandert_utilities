...
public class EntropicAgglomerationItem extends Item {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.iska_utils.entropic_agglomeration.desc0"));
        tooltip.add(Component.translatable("tooltip.iska_utils.entropic_agglomeration.desc1"));
    }
}
