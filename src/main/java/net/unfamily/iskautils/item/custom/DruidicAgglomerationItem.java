...
public class DruidicAgglomerationItem extends Item {
    ...
    public InteractionResult onItemUseFirst(ItemStack stack, UseOnContext context) {
        ...
        if (clicked.is(ModBlocks.SACRED_RUBBER_SAPLING.get())) {
            ...
            if (!clicked.getValue(SacredRubberSaplingBlock.MEGA)) {
                server.setBlock(pos, clicked.setValue(SacredRubberSaplingBlock.MEGA, true), 3);
    ...
    public void appendHoverText(
        ...
        tooltip.accept(Component.translatable("tooltip.iska_utils.druidic_agglomeration.desc0"));
        tooltip.accept(Component.translatable("tooltip.iska_utils.druidic_agglomeration.desc1"));
    }
}
