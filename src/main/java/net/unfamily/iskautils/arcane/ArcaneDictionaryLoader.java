...
public final class ArcaneDictionaryLoader {
    ...
    public static void loadAll(ResourceManager rm) {
        Map<ResourceLocation, JsonElement> merged = IskaUtilsLoadJson.collectMergedJsonForType(
    ...
    public static void loadAllBootstrap() {
        Map<ResourceLocation, JsonElement> merged = IskaUtilsLoadJson.collectFromModJarOnlyForType(
    ...
    private static void parseFile(ResourceLocation fileId, JsonElement root, List<ArcaneDictionaryDefinition.Entry> out) {
    ...
    public static ArcaneDictionaryDefinition.Entry findEntry(ResourceLocation enchant) {
