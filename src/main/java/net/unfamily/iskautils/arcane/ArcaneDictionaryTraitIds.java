...
public final class ArcaneDictionaryTraitIds {
    ...
    public static final Identifier CURSE_OF_PAIN = id("curse_of_pain");
    public static final Identifier CURSE_OF_USELESS = id("curse_of_useless");
    public static final Identifier ARCANE_ECHO = id("arcane_echo");
    public static final Identifier ENTROPIC_CAPACITY = id("entropic_capacity");
    public static final Identifier ENTROPIC_RAGE = id("entropic_rage");
