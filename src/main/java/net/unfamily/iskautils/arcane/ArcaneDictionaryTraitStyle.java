...
public final class ArcaneDictionaryTraitStyle {
    ...
    public static int resolveRgb(Identifier traitId) {
    ...
    public static Component traitName(Identifier traitId) {
        return traitName(traitId, resolveRgb(traitId));
    }

    public static Component traitName(Identifier traitId, int rgb) {
        return Component.translatable(traitNameKey(traitId)).withStyle(style(rgb));
    }

    public static Component traitNameAndLevel(Identifier traitId, int level) {
    ...
    public static String traitNameKey(Identifier traitId) {
