...
public final class LuckyEffect implements ArcaneDictionaryEffect {

    private final ResourceLocation id;

    public LuckyEffect(ResourceLocation id) {
        this.id = id;
    }
    ...
    public void onPlayerTick(ArcaneDictionaryEffectContext ctx) {
        ...
        ctx.player().addEffect(new MobEffectInstance(
                MobEffects.LUCK, ArtifactTickIntervals.POTION_DURATION_TICKS, amp, true, false, true));
    }
