...
public final class ShopEntryTypeRegistry {
    private static final Map<ResourceLocation, ShopEntryTypeHandler> BY_ID = new LinkedHashMap<>();
    ...
    public static synchronized void register(ShopEntryTypeHandler handler) {
        ...
        ResourceLocation id = handler.id();
    ...
    @Nullable
    public static ShopEntryTypeHandler get(@Nullable ResourceLocation id) {
        ensureBuiltins();
        if (id == null) {
            return null;
        }
    ...
    public static int syncIndex(@Nullable ResourceLocation id) {
        ensureBuiltins();
        if (id == null) {
            return 0;
        }
    ...
    @Nullable
    public static ResourceLocation idBySyncIndex(int index) {
        ensureBuiltins();
