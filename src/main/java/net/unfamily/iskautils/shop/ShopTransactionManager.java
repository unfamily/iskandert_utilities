...
public class ShopTransactionManager {
    ...
    public static boolean buyItem(ServerPlayer player, String entryId, int quantity,
        ...
        ShopPurchaseLimitsData limits = ShopPurchaseLimitsData.get(((net.minecraft.server.level.ServerLevel) player.level()));
        ...
        if (!limits.canTrade(((net.minecraft.server.level.ServerLevel) player.level()), limitPlayerId, limitTeamKey, entry,
        ...
        limits.recordTrade(((net.minecraft.server.level.ServerLevel) player.level()), limitPlayerId, limitTeamKey, entry,
                ShopPurchaseLimitsData.TradeSide.BUY, deliverQty);
        net.unfamily.iskautils.network.packet.ShopPurchaseLimitsS2CPacket.sendTo(player);
