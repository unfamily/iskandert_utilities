...
public final class FactoryLoader {
    ...
    private static void parseFactoryRecipeJson(Identifier id, JsonElement root, List<Source> out) {
    ...
    private static void parseRecipesArray(Identifier fileId, JsonArray recipes, List<Source> out) {
    ...
    private static Selector parseSelector(Identifier fileId, String input) {
        ...
        Identifier itemId = Identifier.tryParse(input);
        if (itemId == null) {
