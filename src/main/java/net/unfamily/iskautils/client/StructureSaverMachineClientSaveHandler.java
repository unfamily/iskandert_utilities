...
public final class StructureSaverMachineClientSaveHandler {
    private static final ModLogger LOGGER = ModLogger.of(StructureSaverMachineClientSaveHandler.class);
        ...
        try {
            ...
            if (player != null) {
                ...
                player.displayClientMessage(
                        Component.translatable("gui.iska_utils.structure_saver.client_success", structureName, operationType), true);
            }
        } catch (Exception e) {
            ...
            if (player != null) {
                player.displayClientMessage(
                        Component.translatable("gui.iska_utils.structure_saver.error.client_save_failed", e.getMessage()), true);
            }
        }
    }
}
