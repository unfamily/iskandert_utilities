...
public class StructureSelectionScreen extends AbstractContainerScreen<StructureSelectionMenu> {
    ...
    private void loadAvailableStructures() {
        // Use getMachineVisibleStructures instead of getAllStructures to filter out machine=false structures
            ...
            try {
                ...
                if (itemId != null) {
                    ...
                    if (item != null && item != net.minecraft.world.item.Items.AIR) {
                        guiGraphics.item(new net.minecraft.world.item.ItemStack(item), x, y);
                        return;
                    }
                }
            } catch (Exception e) {
