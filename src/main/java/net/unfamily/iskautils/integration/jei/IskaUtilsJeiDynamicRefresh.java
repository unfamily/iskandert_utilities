...
public final class IskaUtilsJeiDynamicRefresh {
    ...
    public static void scheduleRefresh(Minecraft mc) {
        if (mc == null || runtime == null || !net.unfamily.iskautils.Config.enableJeiIntegration) {
            return;
        }
    ...
    private static <T> void replaceRecipes(RecipeType<T> type, List<T> lastHolder, List<T> rebuilt) {
