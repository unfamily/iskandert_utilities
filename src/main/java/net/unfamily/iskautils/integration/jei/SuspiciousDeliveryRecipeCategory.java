...
import net.unfamily.iskautils.client.JeiDisplayStacks;
...
public class SuspiciousDeliveryRecipeCategory implements IRecipeCategory<SuspiciousDeliveryJeiRecipe> {
    ...
    public static final Identifier UID =
            Identifier.fromNamespaceAndPath(IskaUtils.MOD_ID, "suspicious_delivery");
    ...
    public static final IRecipeType<SuspiciousDeliveryJeiRecipe> RECIPE_TYPE =
            IRecipeType.create(UID, SuspiciousDeliveryJeiRecipe.class);
    ...
    @Override
    public IRecipeType<SuspiciousDeliveryJeiRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, SuspiciousDeliveryJeiRecipe recipe, IFocusGroup focuses) {
        ...
        builder.addSlot(RecipeIngredientRole.INPUT, ox, oy)
                .addItemStack(JeiDisplayStacks.of(ModItems.SUSPICIOUS_DELIVERY.get()));
    ...
    @Override
    public void draw(
            SuspiciousDeliveryJeiRecipe recipe,
