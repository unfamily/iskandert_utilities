...
/**
 * Shared Pattern Crafter fill logic for JEI / EMI / REI.
...
public final class PatternCrafterRecipeViewerTransfer {
    ...
    public static ItemStack chooseIngredient(ImprovedPatternCrafterBlockEntity be, Ingredient ingredient) {
    ...
    public static String filterSpecFromIngredient(Ingredient ingredient, ItemStack chosen) {
    ...
    /**
     * Applies variables immediately and sets pending pattern on the open Pattern Crafter screen.
     */
    public static TransferStatus applyPrepared(
        ...
        PacketDistributor.sendToServer(new PatternCrafterJeiTransferC2SPacket(
    ...
    @Nullable
    public static TagKey<Item> findSmallestCoveringTag(ItemStack[] choices) {
