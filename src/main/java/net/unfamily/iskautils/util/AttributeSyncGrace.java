...
public final class AttributeSyncGrace {
     ...
     */
    public static boolean shouldRemoveEquippedBonus(ServerPlayer player, Identifier bonusId, boolean equipped) {
    ...
    private static String streakKey(UUID playerId, Identifier bonusId) {
