...
final class ModTerrainKindUtil {
    private static final TagKey<Block> MINECRAFT_GRASS_BLOCKS_TAG =
            TagKey.create(Registries.BLOCK, net.minecraft.resources.ResourceLocation.withDefaultNamespace("grass_blocks"));
    private static final TagKey<Block> MINECRAFT_GRASS_TAG =
            TagKey.create(Registries.BLOCK, net.minecraft.resources.ResourceLocation.withDefaultNamespace("grass"));
    private static final TagKey<Block> MINECRAFT_DIRT_TAG =
            TagKey.create(Registries.BLOCK, net.minecraft.resources.ResourceLocation.withDefaultNamespace("dirt"));
