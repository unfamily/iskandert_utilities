...
public final class ScannerSpawnerModes {
    ...
    private static final ResourceLocation SPAWNER_ID = BuiltInRegistries.BLOCK.getKey(Blocks.SPAWNER);
    private static final ResourceLocation TRIAL_SPAWNER_ID = BuiltInRegistries.BLOCK.getKey(Blocks.TRIAL_SPAWNER);
    ...
    public static boolean isKnownSpawnerBlock(ResourceLocation id) {
