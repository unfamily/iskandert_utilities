...
With crystals and an <ItemImage id="iska_utils:entropic_smithing_template" /> **Entropic Smithing Template**, upgrade **netherite** gear into the **entropic** set at a **smithing table** (see **Entropic gear**).
